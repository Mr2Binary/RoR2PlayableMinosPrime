...
using MinosMod.Modules.Characters;
using MinosMod.Survivors.Minos.Components;
...
namespace MinosMod.Survivors.Minos
{
    public class MinosSurvivor : SurvivorBase<MinosSurvivor>
    {
        ...
        public override string survivorTokenPrefix => MINOS_PREFIX;
        
        public override BodyInfo bodyInfo => new BodyInfo
        {
            bodyName = bodyName,
            bodyNameToken = MINOS_PREFIX + "NAME",
            subtitleNameToken = MINOS_PREFIX + "SUBTITLE",

            characterPortrait = assetBundle.LoadAsset<Texture>("texMinosIcon"),
        ...
        public override ItemDisplaysBase itemDisplays => new MinosItemDisplays();
        ...
        public override void Initialize()
        {
            ...
            //ConfigEntry<bool> characterEnabled = Config.CharacterEnableConfig("Survivors", "Minos");
        ...
        public override void InitializeCharacter()
        {
            ...
            MinosAssets.Init(assetBundle);
            MinosBuffs.Init(assetBundle);
        ...
        public override void InitializeEntityStateMachines() 
        {
            ...
            //if you set up a custom main characterstate, set it up here
                //don't forget to register custom entitystates in your MinosStates.cs

            Prefabs.AddEntityStateMachine(bodyPrefab, "Weapon");
            Prefabs.AddEntityStateMachine(bodyPrefab, "Weapon2");
            Prefabs.AddEntityStateMachine(bodyPrefab, "Combat, Override");
        }
        ...
        private void AddPassiveSkill()
        {
            ...
            {
                enabled = true,
                skillNameToken = MINOS_PREFIX + "PASSIVE_NAME",
                skillDescriptionToken = MINOS_PREFIX + "PASSIVE_DESCRIPTION",
        ...
        private void AddSpecialSkills()
        {
            ...
            {
                skillName = "MinosBomb",
                skillNameToken = MINOS_PREFIX + "SPECIALNAME",
                ...
                isCombatSkill = true,
                mustKeyPress = false,
                resetCooldownTimerOnUse = true, //CHANGE
            });
        ...
        public override void InitializeSkins()
        {
            ...
            //SkinDef masterySkin = Modules.Skins.CreateSkinDef(MINOS_PREFIX + "MASTERY_SKIN_NAME",
            //    assetBundle.LoadAsset<Sprite>("texMasteryAchievement"),
            //    defaultRendererinfos,
            //    prefabCharacterModel.gameObject,
            //    MinosUnlockables.masterySkinUnlockableDef);
            ...
            //masterySkin.rendererInfos[0].defaultMaterial = assetBundle.LoadMaterial("matMinosAlt");
            //masterySkin.rendererInfos[1].defaultMaterial = assetBundle.LoadMaterial("matMinosAlt");
            //masterySkin.rendererInfos[2].defaultMaterial = assetBundle.LoadMaterial("matMinosAlt");
        ...
        public override void InitializeCharacterMaster()
        {
            ...
            MinosAI.Init(bodyPrefab, masterName);
